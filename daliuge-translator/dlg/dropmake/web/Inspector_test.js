...
Inspector.prototype.showObjectProperties = function (obj) {
    ...
    //alert(proto.constructor === Object);
    ...
    if (this.propertyNames !== null) { // given list of property names
        ...
        var name = 'data';
        var gok = {
            '__gohashid': 1, 'loc': 1, 'isGroup': 1, 'group': 1,
        ...
        for (var prop in obj) {
            ...
            */
            ...
            //this.appendProperty(prop, options, obj[prop]);
        }
    } else { // GoJS object
...
Inspector.createSection = function (name) {
    ...
    //h3.innerHTML = name + " Properties"; chen.wu
    h3.innerHTML = "DROP Parameters";
    div.appendChild(h3);
    return div;
}
...
View.defaultSetter = function (diagram, view, propname, value) {
    ...
    this.object[propname] = value; // save in the inspector only
    /*
    if (propname == 'clean') {
      propname = 'clean_para';
    }
    */
    ...
    //alert(this.object.toString() + "**" + propname.toString() + "-" + value.toString());
    diagram.model.setDataProperty(this.object, propname.toString(), value);
    //alert(diagram.model.nodeDataArray[0]["clean_para"]);
    //diagram.model.
}
...
View.defaultDataSetter = function (diagram, view, propname, value) {
    ...
    */
    ...
    //alert(propname.toString() + ":" + value.toString());
