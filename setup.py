...
setup(
      ...
      install_requires=["Pyro4", "luigi", "psutil", "paramiko", "bottle", "tornado", "drive-casa", "docker-py","spead2==0.4.0"],
      dependency_links=["https://github.com/davepallot/drive-casa/tarball/0.6.7#egg=drive-casa-0.6.7",
