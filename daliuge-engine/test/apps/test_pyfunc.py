...
def _PyFuncApp(oid, uid, f, **kwargs):
    ...
    return pyfunc.PyFuncApp(oid, uid,
                            func_name=fname,
                            func_code=fcode,
...
class TestPyFuncApp(unittest.TestCase):
    ...
    def test_invalid_function_param(self):
        ...
        self.assertRaises(InvalidDropException, pyfunc.PyFuncApp, 'a', 'a', func_name='func1')

    def test_function_invalid_module(self):
        # The function lives in an unknown module/package
        self.assertRaises(InvalidDropException, pyfunc.PyFuncApp, 'a', 'a', func_name='doesnt_exist.func1')
