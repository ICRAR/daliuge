...
# @param tag template
# @param func_name Function Name//String/ComponentParameter/readwrite//False/False/Python function full load path
# @param func_code Function Code//String/ComponentParameter/readwrite//False/False/Python function code, e.g. 'def function_name(args): return args'
...
# @param input_parser Input Parser/pickle/Select/ComponentParameter/readwrite/raw,pickle,eval,npy,path,dataurl/False/False/Input port parsing technique
# @param output_parser Output Parser/pickle/Select/ComponentParameter/readwrite/raw,pickle,eval,npy,path,dataurl/False/False/Output port parsing technique
